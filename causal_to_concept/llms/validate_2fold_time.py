...
def main(): 
    ...
    # Timing accumulator (shared across the run)
    timing_stats = TimingStats() if args.timing else None
    ...
    for i in range(args.num_fold):
        ...
        curr_fold_results = alt_tqa_evaluate(
            ...
            timing_baseline=(not args.timing_no_baseline)
        )

        if timing_stats is not None:
            # Print a clean timing breakdown (averaged)
            print(timing_stats.summary_str())
